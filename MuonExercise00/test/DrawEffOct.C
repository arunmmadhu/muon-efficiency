void DrawEffOct()
{
  TFile *file0=new TFile("output_40_Oct_HV0.root");
  TFile *file1=new TFile("output_40_Oct_175.root");
  TFile *file2=new TFile("output_40_Oct_200.root");
  TFile *file3=new TFile("output_40_Oct_225.root");
  TFile *file4=new TFile("output_40_Oct_250.root");
  TFile *file5=new TFile("output_40_Oct_300.root");
  TFile *file6=new TFile("output_40_Oct_400.root");
  ...
  */
  ...
  int n_correlatedlcts_c1_tot_Oct_HV0=hist0->GetBinContent(1);
  int n_correlatedlcts_c2_tot_Oct_HV0=hist0->GetBinContent(2);
  ...
  std::cout << "No. of correlated LCTs in ME1/1: " <<n_correlatedlcts_c1_tot_Oct_175 << " No. of correlated LCTs in ME2/1: " <<n_correlatedlcts_c2_tot_Oct_175 << std::endl;
  ...
  /*
  TH1F* h1 = new TH1F("h1","ME1/1 Correlated LCT Digi Found, Test 40", 6, Lower);
  ...
  TH1F* h2 = new TH1F("h2","ME2/1 Correlated LCT Digi Found, Test 40", 6, Lower);
  ...
  */
  ...
  h1->SetBinContent(1, (n_correlatedlcts_c1_tot_Oct_175/(float)n_correlatedlcts_c1_tot_Oct_HV0));
  h1->SetBinContent(2, (n_correlatedlcts_c1_tot_Oct_200/(float)n_correlatedlcts_c1_tot_Oct_HV0));
  h1->SetBinContent(3, (n_correlatedlcts_c1_tot_Oct_225/(float)n_correlatedlcts_c1_tot_Oct_HV0));
  h1->SetBinContent(4, (n_correlatedlcts_c1_tot_Oct_250/(float)n_correlatedlcts_c1_tot_Oct_HV0));
  h1->SetBinContent(5, (n_correlatedlcts_c1_tot_Oct_300/(float)n_correlatedlcts_c1_tot_Oct_HV0));
  h1->SetBinContent(6, (n_correlatedlcts_c1_tot_Oct_400/(float)n_correlatedlcts_c1_tot_Oct_HV0));
  h1->SetBinContent(7, (n_correlatedlcts_c1_tot_Oct_HV0/(float)n_correlatedlcts_c1_tot_Oct_HV0));
  
  TH1F* h2 = new TH1F("h2","ME2/1 Correlated LCT Digi Found, Test 40", 7, 0,7);
  h2->SetBinContent(1, (n_correlatedlcts_c2_tot_Oct_175/(float)n_correlatedlcts_c1_tot_Oct_175));
  h2->SetBinContent(2, (n_correlatedlcts_c2_tot_Oct_200/(float)n_correlatedlcts_c1_tot_Oct_200));
  h2->SetBinContent(3, (n_correlatedlcts_c2_tot_Oct_225/(float)n_correlatedlcts_c1_tot_Oct_225));
  h2->SetBinContent(4, (n_correlatedlcts_c2_tot_Oct_250/(float)n_correlatedlcts_c1_tot_Oct_250));
  h2->SetBinContent(5, (n_correlatedlcts_c2_tot_Oct_300/(float)n_correlatedlcts_c1_tot_Oct_300));
  h2->SetBinContent(6, (n_correlatedlcts_c2_tot_Oct_400/(float)n_correlatedlcts_c1_tot_Oct_400));
  h2->SetBinContent(7, (n_correlatedlcts_c2_tot_Oct_HV0/(float)n_correlatedlcts_c1_tot_Oct_HV0));
  ...
  THStack *hs = new THStack("hs","No of Correlated LCT Digi, Test 40, ME1/1 at HV0");
  hs->Add(h1);
  hs->Add(h2);
  hs->SetMinimum(0.9);
