void DrawHist()
{
  ...
  TH1F *hist9 = (TH1F*)file1->GetDirectory("demo;")->Get("nCorrelatedLCTC1Test1");
  hist9->GetXaxis()->SetTitle("Number of Correlated LCT per event");
  hist9->GetYaxis()->SetTitle("Events");
  hist9->SetTitle("ME1/1 Correlated LCT Digi, Test 27: Measurement 7242");
  TH1F *hist10 = (TH1F*)file3->GetDirectory("demo;")->Get("nCorrelatedLCTC1Test2");
  hist10->GetXaxis()->SetTitle("Number of Correlated LCT per event");
  hist10->GetYaxis()->SetTitle("Events");
  hist10->SetTitle("ME1/1 Correlated LCT Digi, Test 40: Measurement 7347");
  TH1F *hist11 = (TH1F*)file2->GetDirectory("demo;")->Get("nCorrelatedLCTC2Test1");
  hist11->GetXaxis()->SetTitle("Number of Correlated LCT per event");
  hist11->GetYaxis()->SetTitle("Events");
  hist11->SetTitle("ME2/1 Correlated LCT Digi, Test 27: Measurement 7315");
  TH1F *hist12 = (TH1F*)file3->GetDirectory("demo;")->Get("nCorrelatedLCTC2Test2");
  hist12->GetXaxis()->SetTitle("Number of Correlated LCT per event");
  hist12->GetYaxis()->SetTitle("Events");
  hist12->SetTitle("ME2/1 Correlated LCT Digi, Test 40: Measurement 7347");
  ...
  // Draw histograms as scatter plots
